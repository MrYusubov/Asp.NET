    ...
    public class PagingTagHelper : TagHelper
    {
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            ...
            if (PageCount > 1)
            {
                ...
                if (CurrentPage > 1)
                {
                    sb.AppendFormat("<li class='page-item'><a class='page-link' href='/product/index?page={0}&category={1}'>Previous</a></li>", CurrentPage - 1, CurrentCategory);
                }
                else
                {
                ...
                {
                    sb.AppendFormat("<li class='page-item'><a class='page-link' href='/product/index?page={0}&category={1}'>Next</a></li>", CurrentPage + 1, CurrentCategory);
                }
                else
                {
